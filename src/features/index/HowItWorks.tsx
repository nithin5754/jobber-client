    ...
    <section className="container mx-auto items-center bg-white">
      <div className="px-4 py-8 sm:py-16 lg:px-6">
        <div className="mb-8 lg:mb-16">
          <h2 className="mb-4 text-xl lg:text-2xl font-normal text-center tracking-tight text-customViolet hover:text-customPurple">
        ...
        <div className="space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-4">
          <div className="text-center">
            <div className="my-0 mx-auto mb-4 flex h-10 w-10 items-center justify-center rounded-full lg:h-12 lg:w-12">
              <img src={create} className="text-primary-600 dark:text-primary-300 h-15 w-15 dark:text-customPurple hover:text-customViolet" alt="" />
            </div>
            <h3 className="mb-2 text-base lg:text-xl font-bold dark:text-customPurple hover:text-customViolet">Create an account</h3>
            <p className="text-gray-500 lg:text-base dark:text-gray-400">Create an account on codehirepro</p>
          </div>
          <div className="text-center">
            <div className="my-0 mx-auto mb-4 flex h-10 w-10 items-center justify-center rounded-full lg:h-12 lg:w-12">
              <img src={browseImage} className="text-primary-600 dark:text-primary-300 h-15 w-15" alt="" />
            </div>
            <h3 className="mb-2 text-base lg:text-xl font-bold dark:text-customPurple hover:text-customViolet">Browse Experts</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="mb-2 text-base lg:text-xl font-bold dark:text-customPurple hover:text-customViolet">Contact Experts</h3>

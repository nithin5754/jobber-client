...
import { IGigViewReviewsProps } from 'src/features/gigs/interface/gigi.interface';
import { IRatingCategories, IRatingCategoryItem, IReview } from 'src/features/order/interfaces/review.interface';
...
const GigReviewOverview: FC<IGigViewReviewsProps> = ({ showRatings, hasFetchedReviews, reviews }): ReactElement => {
            ...
            <div key={item.id}>
              <div className="flex flex-col gap-y-3 md:flex-row md:gap-x-4">
                <img
                  ...
                  src={CLOUDINARY_PICTURE_URL(`${item.reviewerImage}`)}
                  alt="Reviewer Image"
                />

  ...
  return (
    <div className="flex w-64 min-w-[100%] flex-col">
      <div className="z-1 mt-2 flex flex-col rounded">
        {checkUrlExtension(`${message.fileType}`) === 'image' && <img className="h-36 w-64 object-cover" src={message.file} alt={message.fileName} />}
      ...
      <div className="flex w-auto justify-between">
        <div className="flex gap-1 truncate" onClick={()=>downloadChatFile(message.url as string,message.fileName as string)}>

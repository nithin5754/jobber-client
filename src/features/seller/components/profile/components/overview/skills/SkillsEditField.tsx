...
import { FC, ReactElement, useContext, useState, LazyExoticComponent, lazy, ForwardRefExoticComponent, ChangeEvent } from 'react';
...
const SkillsButton: LazyExoticComponent<FC<IButtonProps>> = lazy(() => import('src/shared/button/Button'));

const SkillsTextInput: LazyExoticComponent<

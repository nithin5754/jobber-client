          ...
          <div className="border-grey border bg-white py-2">
            <div className="flex flex-col gap-y-3 pt-2">
              <img
                ...
                src={CLOUDINARY_PICTURE_URL(`${seller?.profilePicture}`)}
                alt="Seller image"
              />
        ...
        <div className="border-grey border bg-white">
          <ul className="flex w-full cursor-pointer list-none flex-col px-6 md:flex-row">
            <li
              ...
              className={`mr-9 w-full py-3 text-xs font-bold md:w-auto md:py-5 md:text-sm${type === 'active' ? ' text-customViolet md:border-b-2 md:border-customViolet' : ''}`}
            >
              ACTIVE GIGS
            </li>
            <li
              onClick={() => setType('paused')}
              className={`mr-9 w-full py-3 text-xs font-bold md:w-auto md:py-5 md:text-sm${type === 'paused' ? ' text-customViolet md:border-b-2 md:border-customViolet' : ''}`}
            >
              PAUSED
            </li>
            <li
              onClick={() => setType('orders')}
              className={`mr-9 w-full py-3 text-xs font-bold md:w-auto md:py-5 md:text-sm${type === 'orders' ? ' text-customViolet md:border-b-2 md:border-customViolet' : ''}`}
            >
              ACTIVE ORDERS
            </li>
          </ul>

...
const OrderDetailsTable:FC<IOrderProps> = ({authUser,order}):ReactElement => {
                ...
                <div className="flex justify-between">
                  <div className="flex gap-2 text-sm md:text-base">
                    <div className="flex gap-2">
                      Buyer:
                      <Link to="" className="font-bold text-customPurple hover:text-customViolet hover:underline">
                        {order.buyerUsername}
                      </Link>
                    </div>
                  ...
                  {order.buyerUsername === authUser.username && (
                    ...
                    >
                      <div className="cursor-pointer text-customPurple hover:text-customViolet underline">Download invoice</div>
                    </PDFDownloadLink>
                  )}
                </div>
                <div className="mt-4">

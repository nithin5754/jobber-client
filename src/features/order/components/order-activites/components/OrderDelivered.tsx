...
import { FC, forwardRef, ForwardRefExoticComponent, lazy, RefAttributes, useContext, useState } from "react"
import { FaGift, FaChevronDown, FaChevronUp, FaDownload, FaCheck } from "react-icons/fa";
import ChatBox from "src/features/chat/components/chatBox/ChatBox";
import { IChatSellerProps, IChatBuyerProps } from "src/features/chat/interface/chat.interface";

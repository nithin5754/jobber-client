...
import { FaRegFile, FaPencilAlt, FaPlaceOfWorship, FaRegClock } from 'react-icons/fa';
      ...
      <div className="w-full">
          ...
          <div className="w-full cursor-pointer">
            <div className="border-grey mt-2 flex items-center gap-2 border-b pb-6 text-gray-500">
              <span className="text-base font-bold">
                {order?.buyerUsername === authUser?.username ? 'You ' : order?.buyerUsername}
               placed the order
              </span>
        ...
        <div className="flex gap-4 pt-4">
          ...
          <div className="w-full cursor-pointer">
            <div className="border-grey mt-2 flex items-center gap-2 border-b pb-6 text-gray-500">
              <span className="text-base font-bold">
                {order?.buyerUsername===authUser?.username?'You ' :'The '}
                order started</span>

...
import { IOffer, IOrder } from '../interfaces/order.interface';
import { generateRandomNumbers } from 'src/shared/utils/utils.service';
...
const buyer=useSelector(useGetBuyerDetails)
...
navigate(`/orders/${orderId}/activities`, { state:order});
        ...
        <div className="order-last w-full p-4 lg:order-first lg:w-2/3">
            ...
            <div className="border-grey border">
                ...
                <div className="flex flex-col px-4 pb-4">
                    <TextAreaInput rows={5} name="requirement" value={requirement} placeholder="Write a brief description..."
                    ...
                    <Button
                        ...
                        label="Start Order" onClick={startOrder}/>
                </div>
            </div>
        </div>

  ...
  return (
   ...
   <div className="relative">
      {gigCardItemModal.overlay && (
        <div className="border-grey absolute bottom-0 top-0 mb-8 w-full cursor-pointer border bg-white">
          ...
          <ul className="list-none pl-0">
            ...
            <li>
                <div onClick={() => onToggleGig(gig?.id as string, !gig?.active)} className="my-1 flex w-full cursor-pointer gap-4 px-4 pt-3">
                  {!gig?.active ? (
      ...
      <div className="border-grey mb-8 h-72 p-2  flex cursor-pointer flex-col gap-2 border">
        <Link onClick={()=>dispatch(updateHeader('home'))} to={`/gig/${lowerCase(gig?.username)}/${gig?.title}/${gig?.sellerId}/${gig?.id}/view`}>

...
import { IApprovalModalContent, IModalBgProps, IModalProps } from "./interfaces/modal.interface";


const ModalButton: LazyExoticComponent<FC<IButtonProps>> = lazy(() => import('src/shared/button/Button'));
...
const ApprovalModal:FC<IModalProps> = ({approvalModalContent,hideCancel = false, onClick, onClose}):ReactElement => {
    ...
    const {body,btnColor,btnText,header}=approvalModalContent as IApprovalModalContent
  return (
    <ModalBg>

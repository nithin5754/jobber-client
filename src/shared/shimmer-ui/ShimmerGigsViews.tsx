    ...
    <div className="flex items-center px-6 py-6 sm:items-start">
        <div className="flex w-full flex-col justify-between">
            <div className="flex flex-col gap-2 md:flex-row">
                ...
                <span
                    className="flex self-center text-base font-bold cursor-pointer  md:text-lg lg:text-2xl  hover:underline">
                    <h1 >
                    
                    </h1>
                </span>
            </div>
            <h4 className="pt-1 text-center text-sm sm:text-left"></h4>
        </div>
    </div>
    <div
...
export default ShimmerGigsViews